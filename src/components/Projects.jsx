...
const projects = [
  {
    name: "DsaMentor.ai",
    image: "/dsamentor.png",
    description: "Built a purpose-built DSA and LeetCode mentor chatbot that teaches instead of just answering. Integrated Groq LLM API on a Node.js backend with concept and mentor modes.",
  ...
  },
  {
    ...
    description: "AI-powered web app fetching movie data via TMDB API and enhancing it with audience sentiment analysis using Groq AI. Focused on clean architecture and real-time insights.",
  ...
  },
  {
    ...
    description: "Full-stack system converting long URLs into short links using Base62 encoding. Utilizes PostgreSQL for storage and Redis for high-speed redirects.",
  ...
  },
  {
    name: "QuickBlog",
    image: "/QuickBlog.png",
    description: "Modern blogging platform with AI content generation via Gemini API. Features include JWT authentication and a full MERN stack architecture.",
  ...
  },
  {
    ...
    image: "/portfolio.png",
    description: "A modern, responsive developer portfolio featuring glassmorphism, Framer Motion animations, and a clean UI/UX designed to showcase technical expertise and project work.",
  ...
  },
  {
    ...
    description: "A C++ console application simulating core banking operations using OOP principles and file handling for secure customer data management.",
